  ...
  const profissionaisFiltrados = useMemo(() => {
    ...
    return profissionais.filter(
      (p) =>
        ...
        p.especialidade.toLocaleLowerCase('pt-BR').includes(termo),
    );
  }, [busca, profissionais]);
    ...
    <View style={[styles.tela, { paddingTop: insets.top }]}>
      ...
      <View style={styles.headerWrap}>
        <GlassCard style={styles.headerCard}>
          <View style={styles.headerTextos}>
            <Text style={styles.headerTitulo}>Profissionais</Text>
            <Text style={styles.headerSubtitulo}>Equipe disponível para agendamentos</Text>
          </View>
          <Pressable
      ...
      >
        ...
        {carregando ? (
          ...
          <EstadoVazio
            titulo="Não foi possível carregar profissionais"
            descricao={erro}
            icone="cloud-off"
          />
